...
국내 주요 금융권(시중·지방·인터넷은행, 생·손해보험, 저축은행, 상호금융, 카드, 농협·수협) 핵심 뉴스를 자동 수집해 단일 텔레그램 채널로 발송하는 봇. **증권사·자산운용사 단독 기사는 제외.**
...
# Google 뉴스 — 수협 계열 (2026-05-22 추가)
- 수협 / 수협중앙회 / Sh수협은행 검색
- 노동진+수협 / 신학기+수협 (경영진 실명 기반)
...
### 2026-05-22 — 전 금융권 확장 (증권·운용 제외)

**범위**: 농협·수협 전용에서 → 시중은행·지방은행·인터넷전문은행·생·손해보험·저축은행·상호금융·카드·규제기관까지. 단 증권사·자산운용사 단독 기사는 의도적으로 제외.

**구조적 결정**:
- 증권·운용사명을 KEYWORDS에 넣지 않음 → 1단계 게이트(`is_relevant()`)에서 자동 차단
- 지주·은행 키워드와 증권·운용사가 함께 등장하는 그룹 차원 기사는 자연스럽게 통과 (예: 'KB금융, KB증권 출자')

**확장 항목**:
- KEYWORDS: 5대 금융지주(KB/신한/하나/우리/NH), 시중은행 5사, 지방은행 7사+iM뱅크, 인터넷뱅크 3사, 생명보험 14사, 손해보험 10사, 저축은행 8사, 신협·새마을금고, 카드 9사, 금감원·금융위·예보 등 규제기관
- WHITELIST: 자본 보강, 자본보강, 자본금 증액, 후순위채, 신종자본증권, 하이브리드채 (자본 정책 폭 확대)
- STRUCTURAL: 카드사·보험사·저축은행·인터넷뱅크 PR 패턴 추가 (제휴카드/페이백/특약 출시/앱 리뉴얼/ESG 행보 등)
- LLM 프롬프트: '농협·수협'에서 '국내 주요 금융권'으로 확장 + NO에 '증권사·자산운용사 단독 기사' 명시
- RSS_FEEDS: 5대 금융지주 + 인터넷전문은행 3사 + 보험·저축·카드 업종별 검색 12건 추가
- NAVER_SEARCH_QUERIES: KB금융·신한금융·하나금융·우리금융 추가
- main.py 브랜딩: '금융권 뉴스 모니터링 봇'
- STRUCTURAL '업계 최고' → '업계 최고로 선정/평가/인정'으로 정밀화 (BIS 자본비율 등 비교성 본문 통과 위해)

**검증**: 38건 시뮬레이션 (시중·지방·인터넷뱅크 11, 보험 5, 저축은행 2, 카드 2, 상호금융 2, 규제 2, 농협·수협 회귀 2, 증권 차단 3, 그룹 통과 2, PR 차단 5, 무관 2) — 전건 통과.

### 2026-05-22 — 수협(노동진·신학기) 계열 통합

**문제**: 농협 전용 봇이었으나 운영자가 수협중앙회·Sh수협은행 등 수협 계열 뉴스도 동일 채널로 받기 원함.

**패치**:
- KEYWORDS: 수협 / Sh수협 / Sh수협은행 / 수협은행 / 수협중앙회 / 수협금융 / 수협캐피탈 / 수협증권 / 수협개발 추가
- EXEC_NAMES: 노동진(수협중앙회장), 신학기(Sh수협은행장) 추가
- WHITELIST: 노동진·신학기 + 수산정책·수산자금·수산금융·어업인 대출·어선원 추가
- RSS_FEEDS: 수협 / 수협중앙회 / Sh수협은행 Google 검색 + 노동진+수협 / 신학기+수협 4건 추가
- NAVER_SEARCH_QUERIES: 수협 / Sh수협은행 / 수협중앙회 추가
- LLM 프롬프트: "NH농협" → "NH농협·수협" 확장, NO 카테고리에 수산물·어업 활동·어촌 봉사·어업 봉사 명시
- STRUCTURAL: 수산물 판매·소비촉진·시식·시장방문 / 적조·양식장 피해·피해어가 / 수산물 수출 / 어촌·어업·바다·갯벌·양식 체험 / 어구 수거·폐어구·해양쓰레기·바다정화 추가
- main.py: 봇 시작 메시지 및 로거 "농협" → "농협·수협"
