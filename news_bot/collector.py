...
【차단 NO】
- 상품 출시·홍보·지역 행사·사회공헌·수상·캠페인·직원 미담·협약 체결·교육·봉사
- 조합원 위안·감사 행사, 원로 초청 행사, 경로 행사
- 농촌 인력·계절근로자·영농지원·농산물 생산 관련 (금융과 무관)
- 지역 농협의 지역사회 활동 (금융·은행 업무와 무관한 것)
- 대출·적금 상품 출시, 우대금리 이벤트
...
STRUCTURAL_PROMO_PATTERNS = [
    ...
    '전기차',
    # 경찰 치안·방범 협력 홍보 ('경찰'이 화이트리스트라 STRUCTURAL로 차단)
    '자율방범대', '순찰뱅크', '우리동네 순찰',
